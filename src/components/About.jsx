...
const About = () => {
  ...
  return (
    <div
      ref={sectionRef}
      className="min-h-screen flex flex-wrap flex-col md:flex-row justify-center items-center bg-gray-50 dark:bg-gray-900 px-6 md:px-20 overflow-hidden"
    >
      {!isMobile && (
        <motion.div
        ...
        >
          <img
            ...
            className="w-full max-w-xs sm:max-w-md md:max-w-lg rounded-lg object-cover border-4 border-gray-300 dark:border-gray-700 shadow-lg"
          />
        </motion.div>
      )}
      ...
      <motion.div
        ...
        className="flex-1 text-center md:text-left p-4"
      >
