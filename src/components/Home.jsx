    ...
    <div className="relative min-h-screen flex flex-col md:flex-row justify-center items-center text-left overflow-hidden pt-16 md:pt-20 bg-black">
      ...
      <div
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
                w-80 h-80 sm:w-80 sm:h-80 md:w-96 md:h-80 lg:w-[28rem] lg:h-[22rem] 
                xl:w-[32rem] xl:h-[24rem] 2xl:w-[36rem] 2xl:h-[28rem] 
                bg-black/60 backdrop-blur-3xl rounded-lg flex items-center justify-center"
      ></div>
